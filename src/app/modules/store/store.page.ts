...
import { GridApi, ColDef, GridOptions, GridReadyEvent, CellClickedEvent, GetContextMenuItemsParams, MenuItemDef, ValueGetterParams } from 'ag-grid-community';
...
export class StorePage implements OnInit {
  ...
  constructor(private http: HttpClient, private firestore: AngularFirestore, public firebaseService: FirebaseService, private route: ActivatedRoute) { }
  ngOnInit(): void {
  ...
  onBtExport() {
    this.gridApi.exportDataAsExcel({ columnGroups: true, fileName: 'products' });
  }
  saveData() {
